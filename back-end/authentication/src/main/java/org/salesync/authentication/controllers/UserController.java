...
public class UserController {
    ...
    ResponseEntity<ValidationResponseDto> validate(@RequestHeader("Authorization") String token,
    ...
    ResponseEntity<UserDetailDto> loadUser(@RequestHeader("Authorization") String token,
            @PathVariable String realmName) {
    ...
    ResponseEntity<UserDto> modifyInfo(@PathVariable String realmName, @RequestHeader("Authorization") String token,
    ...
    ResponseEntity<UserDto> resetSettings(@PathVariable String realmName,
    ...
    ResponseEntity<String> resetPassword(@PathVariable String realmName, @RequestHeader("Authorization") String token,
            @RequestBody ResetPasswordDto resetPasswordDto

    ) {
        return ResponseEntity
                .ok(userService.resetPassword(StringUtility.removeBearer(token), realmName, resetPasswordDto));
    }

    @SneakyThrows
    @GetMapping(Routes.USERS)
    ResponseEntity<List<SimpleUserDto>> getUsers(@RequestHeader("Authorization") String token,
            @PathVariable String realmName) {
    ...
    ResponseEntity<SimpleUserDto> getSimpleUser(@PathVariable String realmName, @PathVariable String userId) {
