...
const Header = () => {
  return (
    <div className='fixed left-[76px] top-0 z-50 flex h-14 w-[calc(100vw-76px)] flex-grow items-center justify-between border-[1px] border-input-stroke bg-panel px-3 py-1 dark:border-input-stroke-dark  dark:bg-panel-dark'>
