...
function PalettePanel() {
  return (
    <Panel>
      <div className='mb-5 flex items-center justify-stretch align-middle'>
        <h1 className=''>Color Palette</h1>
      </div>
      <p>Toggle between Light/Dark theme to reflect the palette changes.</p>

      <div className='flex flex-wrap divide-input-stroke-light *:px-4 dark:divide-input-stroke-dark'>
        ...
        <ColorInfo
          color='bg-button-background dark:bg-button-background-dark'
          description='Button Background (Float Up)'
        />
        <ColorInfo color='bg-button-stroke dark:bg-button-stroke-dark' description='Button Stroke (Float Up)' />
        <ColorInfo
          color='bg-input-background dark:bg-input-background-dark'
          description='Input Background (Sink Down)'
        />
