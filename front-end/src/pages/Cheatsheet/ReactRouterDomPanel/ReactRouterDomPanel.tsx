...
function ReactRouterDomPanel() {
  return (
    <Panel>
      ...
      <h1 className='mb-5'>Các khái niệm sẽ sử dụng: (Xem hướng dẫn để biết chức năng và cách sử dụng)</h1>
      <p>React elements: Routes, Route, Link, NavLink, Navigate</p>
      <p>Hooks: useNavigate, useParams, useSearchParams</p>
      <p>React.lazy: Lazy loading của React (tránh tải toàn bộ cái file js trong import trong lần đầu load trang)</p>
    </Panel>
  );
}
